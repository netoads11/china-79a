...
if (($resultado_usuario) AND ($resultado_usuario->num_rows != 0)) {
    ...
    $status_view = '<span class="status-badge red"><div class="small-dot _4px bg-red-300"></div> CANCELADO</span>';
} else {
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <input type="hidden" id="modalExternalReference" value="<?= $data['id']; ?>" required />
                        </div>
                        <div class="box-footer">
                            <br>
                            <form action='payment_manual.php?id=<?= $data['id']; ?>' method="POST">
