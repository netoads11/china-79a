...
log_expfypay("Recebido: ID=$idTransaction, Status=$statusTransaction, Valor=$amount");
    ...
    if ($res->num_rows > 0) {
        ...
        if ($retorna_insert_saldo) {
            ...
            if ($bonusRecebido > 0) {
                ...
                log_expfypay("✓ Bônus registrado em cupom_usados");
            }
            
            log_expfypay("Chamando processarTodasComissoes para User $userId, Valor $valorPago");
